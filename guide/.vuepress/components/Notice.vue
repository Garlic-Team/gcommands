<template>
	<div v-if="showNotice" class="oldversion-notice">
		...
		We no longer provide support, maintain bug fixes or new features for v2 of gcommands. <a href="/guide/additional/fromv3tov4">Please update your bot to version 4.</a>
	</div>
</template>
